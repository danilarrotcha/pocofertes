        ...
        protected override void Seed(OffersContext context)
        {
           ...
           offersManagers.ForEach(om => context.Managers.Add(om));
            ...
            var minMaxOfferStatuses =
                new KeyValuePair<int, int>(offerStatuses.Min(m => m.OfferStatusID), offerStatuses.Max(m => m.OfferStatusID));
            ...
            customers
                ...
                .ForEach(id =>
                {
                    ...
                    var createdOn = new DateTime(2013, GetRandom(1, 12), GetRandom(1, 28));
                    ...
                    context.Offers.Add(new Offer
                    {
                        CreatedOn = createdOn,
                        OfferID = offerIndex++,
                        OfferTypeID = GetRandom(minMaxOfferTypes.Key, minMaxOfferTypes.Value),
                        OfferStatusID = GetRandom(minMaxOfferStatuses.Key, minMaxOfferStatuses.Value),
                        FollowedOn = followedOn,
                        SuccessAmount = GetRandom(25, 90),
                        ReasonID = GetRandom(minMaxOfferReasons.Key, minMaxOfferReasons.Value),
